...
**Bookstore** is a website made for displaying books, adding books, and deleting selected books.
...
```sh
  cd my-folder
  git clone git@github.com:flemton/bookstore.git
```
...
I would like to thank [Microverse](https://github.com/microverseinc) for giving me this project to work on
